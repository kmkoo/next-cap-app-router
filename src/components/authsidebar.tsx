...
export default function AuthSidebar({
  ...
  return (
    <div
      className={`fixed md:relative top-0 right-0 h-full w-64 transition-transform duration-300 ease-in-out z-50
      ${isOpen ? "translate-x-0" : "translate-x-full"} md:translate-x-0
      bg-[#373A3C] text-neutral-100 divide-y-1 divide-neutral-600/50 flex flex-col`}
    >
      <div className="flex flex-col grow mx-6 justify-center pb-30">
        ...
        <div className="flex gap-2 mb-3 items-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
            viewBox="0 0 24 24" width="20" height="20" strokeWidth="2"
        ...
        <form onSubmit={handleLogin} className="flex flex-col">
          ...
          >
            {isLoading ? (
              <svg className="w-6 h-6 mx-auto animate-spin text-white" xmlns="http://www.w3.org/2000/svg"
