...
export default function AuthSidebar() {
  return (
    <div className="bg-neutral-800 text-neutral-100 divide-y-1 divide-zinc-700 flex flex-col w-70 h-full fixed top-0 right-0">
      ...
      <Form action="/" className="flex flex-col grow mx-8 justify-center">
        ...
        <input className="p-2 my-2 rounded-lg bg-neutral-600"
          placeholder="아이디"
        />
        <input className="p-2 my-2 rounded-lg bg-neutral-600"
          placeholder="비밀번호"
